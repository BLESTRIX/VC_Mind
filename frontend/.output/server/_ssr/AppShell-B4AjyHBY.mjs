...
import { I as require_jsx_runtime, M as Slot, d as DialogClose, f as DialogContent, g as DialogTitle, h as DialogPortal, m as DialogOverlay, p as DialogDescription, u as Dialog } from "../_libs/@radix-ui/react-alert-dialog+[...].mjs";
import { t as cva } from "../_libs/class-variance-authority+clsx.mjs";
import { i as cn, t as Button } from "./button-BH9lIckK.mjs";
import { A as ChevronRight, E as CirclePlus, P as Briefcase, h as LogOut, m as PanelLeft, t as X } from "../_libs/lucide-react.mjs";
import { i as SignIn, n as Input, o as useAuth } from "./AuthProvider-fTIyLLZ0.mjs";
import { g as Link, l as useRouterState } from "../_libs/@tanstack/react-router+[...].mjs";
import { p as Skeleton, u as LoadingBlock } from "./primitives-CRCs1YlY.mjs";
import { t as Root } from "../_libs/radix-ui__react-separator.mjs";
import { a as Trigger, i as Root3, n as Portal, r as Provider, t as Content2 } from "../_libs/radix-ui__react-tooltip.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/AppShell-B4AjyHBY.js
...
var NAV = [{
	...
	label: "Deal Flow",
	icon: Briefcase,
	match: (p) => p === "/" || p.startsWith("/applications")
}, {
	to: "/applications/new",
	label: "New Application",
	icon: CirclePlus,
	match: (p) => p === "/applications/new"
}];
function AppShell({ children, breadcrumbs, pageActions }) {
	const { session, loading, signOut } = useAuth();
	if (loading) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", {
		className: "grid min-h-dvh place-items-center bg-background",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoadingBlock, { label: "Loading session…" })
	});
	if (!session) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SignIn, {});
...
function AppSidebar({ email, onSignOut }) {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarFooter, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "grid h-7 w-7 shrink-0 place-items-center rounded-full bg-muted text-xs font-medium uppercase text-muted-foreground",
						children: email.slice(0, 1) || "?"
...
function TopBar({ breadcrumbs, pageActions }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
		className: "sticky top-0 z-30 flex h-12 items-center gap-3 border-b border-border/70 bg-background/85 px-3 backdrop-blur supports-[backdrop-filter]:bg-background/75 sm:px-6",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarTrigger, { className: "h-8 w-8" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Separator, {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
				...
				children: (breadcrumbs ?? [{
					label: "Deal Flow",
					to: "/"
				}]).map((c, i, arr) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "flex min-w-0 items-center gap-1",
					children: [i > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRight, { className: "h-3 w-3 shrink-0 text-muted-foreground/60" }), c.to && i < arr.length - 1 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						to: c.to,
						className: "truncate rounded px-1 py-0.5 hover:bg-accent hover:text-foreground",
						children: c.label
					}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: cn("truncate px-1", i === arr.length - 1 && "text-foreground font-medium"),
						children: c.label
					})]
				}, i))
			}),
			pageActions && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
