...
//#region node_modules/.nitro/vite/services/ssr/assets/button-DLX5oFRp.js
...
function resolveApiBaseUrl() {
	const configured = "".replace(/\/$/, "");
	if (configured) return configured;
	if (typeof window !== "undefined") return "";
	const deploymentHost = processModule.env.VERCEL_URL ?? processModule.env.VERCEL_BRANCH_URL ?? processModule.env.URL;
