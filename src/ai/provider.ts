...
export type GenerateStructuredInput<T> = { model: string; systemPrompt: string; userPrompt: string; schema: z.ZodType<T>; schemaName: string; temperature?: number; timeoutMs?: number; metadata?: Record<string, unknown> };
